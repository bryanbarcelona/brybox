...
class _AudioMetadataExtractor:
    ...
    def extract_media_created_date(self, file_path: str) -> Optional[str]:
        """
        ...
        try:
            with exiftool.ExifToolHelper() as et:
                ...
                logger.warning(f"No media created date found in {Path(file_path).name}")
                return None
    ...
    def _parse_quicktime_date(self, date_str: str) -> Optional[datetime]:
        """
    ...
    def validate_dates(self, metadata_date: Optional[str], filename_date: Optional[str], 
